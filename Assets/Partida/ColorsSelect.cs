...
public class ColorsSelect : MonoBehaviour
{
    ...
    Color similar_selected = new Color(0.5f, 0.5f, 1f);           //Frase letter same symbol as selected
    ...
    Color similar_selected_dark = new Color(0.5f, 0.5f, 1f);      //Frase letter same symbol as selected darkmode
